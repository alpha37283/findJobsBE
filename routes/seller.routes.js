...
const {createSeller, loginSeller, getSeller, updateSeller, deleteSeller, getSellerImage} = require('../controller/seller.controller.js');
...
routerSeller.get('/image/:id', getSellerImage)
